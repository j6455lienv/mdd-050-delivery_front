...
define("ipi-mdd-050-web/adapters/application", ["exports", "ember-data", "ipi-mdd-050-web/config/environment"], function (exports, _emberData, _environment) {
  "use strict";
    ...
    actions: {
      rechercher: function rechercher() {
        ...
        this.store.queryRecord("employe", { matricule: this.get("matricule") }).then(function (employe) {
          ...
          if (error.message) {
            _this.toast.error("Erreur " + error.status + ", " + error.message);
          }
        });
      }
    }
...
define("ipi-mdd-050-web/controllers/employes/detail", ["exports", "ipi-mdd-050-web/config/environment"], function (exports, _environment) {
  "use strict";
  ...
  exports.default = Ember.Controller.extend({
    ...
    actions: {
      ...
      deleteTechniciens: function deleteTechniciens(id) {
        ...
        this.get('ajax').request(_environment.default.apiUrl + "/managers/" + this.get("model.id") + "/equipe/" + id + "/remove").then(function () {
      ...
      addTechniciens: function addTechniciens(matricule) {
        ...
        this.get('ajax').request(_environment.default.apiUrl + "/managers/" + this.get("model.id") + "/equipe/" + matricule + "/add").then(function (technicien) {
      ...
      addManager: function addManager(matricule) {
        ...
        this.get('ajax').request(_environment.default.apiUrl + "/techniciens/" + this.get("model.id") + "/manager/" + matricule + "/add").then(function (manager) {
...
define("ipi-mdd-050-web/controllers/index", ["exports", "ipi-mdd-050-web/config/environment"], function (exports, _environment) {
  "use strict";
...
define("ipi-mdd-050-web/routes/application", ["exports", "ipi-mdd-050-web/config/environment"], function (exports, _environment) {
  "use strict";
  ...
  exports.default = Ember.Route.extend({
    model: function model() {
      return Ember.$.ajax(_environment.default.apiUrl + "/employes/count").catch(function (error) {
        return "?";
      });
    }
  });
  ...
  exports.default = Ember.Route.extend({
    ...
    actions: {
      error: function error(_error, transition) {
        ...
        if (_error.message) {
          this.toast.error("Erreur HTTP '" + _error.status + "', " + _error.message);
        }
      }
    }
  });
...
if (!runningTests) {
  require("ipi-mdd-050-web/app")["default"].create({"name":"ipi-mdd-050-web","version":"0.0.0+627ba250"});
}
